...
<template>
  <section>
    ...
    <section class=" lg:w-1/2 h-screen flex flex-col gap-2 justify-center text-center">
      <h1 class="text-5xl lg:text-8xl text-transparent bg-clip-text heading-gradient font-bold">
        Gallery
      </h1>
      <p class="text-sm lg:text-lg px-5">
